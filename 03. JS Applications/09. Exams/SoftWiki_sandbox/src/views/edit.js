...
export async function editPage(ctx) {
    ...
    async function onSubmit(event) {
        ...
        if (Object.values(updatedArticle).some(x => !x)) {
            return alert('All fields are required!');
        }

        if (updatedArticle.category == 'JavaScript' || updatedArticle.category == 'Java' || updatedArticle.category == 'C#' || updatedArticle.category == 'Python') {
